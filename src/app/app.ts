...
export class App {
  ...
  constructor(private breakpointObserver: BreakpointObserver, public colorChange: HalloweenColorChange, private translate: TranslateService) {
    ...
    console.log('App initializing language. Browser:', browserLang, 'Using:', langToUse);
